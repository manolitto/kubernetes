...
MASTER_INTERNAL_IP="${KUBE_AWS_MASTER_INTERNAL_IP:-172.20.0.9}"
MINION_INTERNAL_IP_PREFIX="${KUBE_AWS_MINION_INTERNAL_IP_PREFIX:-172.20.0.1}"
VPC_CIDR="${KUBE_AWS_VPC_CIDR:-172.20.0.0/16}"
SUBNET_CIDR="${KUBE_AWS_SUBNET_CIDR:-172.20.0.0/24}"
SUBNET_NAME="${KUBE_AWS_SUBNET_NAME:-kubernetes-subnet}"
ROUTE_TABLE_NAME="${KUBE_AWS_ROUTE_TABLE_NAME}"
